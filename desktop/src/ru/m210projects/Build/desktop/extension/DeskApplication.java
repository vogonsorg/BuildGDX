...
public class DeskApplication implements Application {
	...
	public DeskApplication (ApplicationListener listener, Canvas canvas) {
		this(listener, new LwjglApplicationConfiguration(), new DeskGraphics(canvas));
	}

	public DeskApplication (ApplicationListener listener, DeskApplicationConfiguration config, Canvas canvas) {
		this(listener, config, new DeskGraphics(canvas, config));
	}
