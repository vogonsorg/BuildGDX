...
public class Jogles20 implements GL20 {
	...
	public void glBlendFuncSeparate(int srcRGB, int dstRGB, int srcAlpha,
			int dstAlpha) {
		GLContext.getCurrentGL().glBlendFuncSeparate(srcRGB, dstRGB, srcAlpha,
				dstAlpha);
	}
	...
	public void glCompressedTexImage2D(int target, int level,
		...
		GLContext.getCurrentGL().glCompressedTexImage2D(target, level,
	...
	public void glCompressedTexSubImage2D(int target, int level, int xoffset,
			...
			Buffer data) {
		GLContext.getCurrentGL().glCompressedTexSubImage2D(target, level,
	...
	public void glCopyTexImage2D(int target, int level, int internalformat,
		...
		GLContext.getCurrentGL().glCopyTexImage2D(target, level,
	...
	public void glCopyTexSubImage2D(int target, int level, int xoffset,
		...
		GLContext.getCurrentGL().glCopyTexSubImage2D(target, level, xoffset,
	...
	public void glDrawElements(int mode, int count, int type, Buffer indices) {
		if (GLContext.getCurrentGL().isGLES2()) {
			GLContext.getCurrentGL().getGLES2()
	...
	public void glFramebufferRenderbuffer(int target, int attachment,
		...
		GLContext.getCurrentGL().glFramebufferRenderbuffer(target, attachment,
	...
	public void glFramebufferTexture2D(int target, int attachment,
		...
		GLContext.getCurrentGL().glFramebufferTexture2D(target, attachment,
	...
	public String glGetActiveAttrib(int program, int index, IntBuffer size,
		...
		GLContext
				.getCurrentGL()
				.getGL2ES2()
				.glGetActiveAttrib(program, index, 256, length, 0, sizeTmp, 0,
						typeTmp, 0, name, 0);
	...
	public String glGetActiveUniform(int program, int index, IntBuffer size,
		...
		GLContext
				.getCurrentGL()
				.getGL2ES2()
				.glGetActiveUniform(program, index, 256, length, 0, sizeTmp, 0,
						typeTmp, 0, name, 0);
	...
	public void glGetAttachedShaders(int program, int maxcount, Buffer count,
		...
		GLContext
				.getCurrentGL()
				.getGL2ES2()
				.glGetAttachedShaders(program, maxcount, (IntBuffer) count,
						shaders);
	}
	...
	public void glGetFramebufferAttachmentParameteriv(int target,
		...
		GLContext.getCurrentGL().glGetFramebufferAttachmentParameteriv(target,
	...
	public String glGetProgramInfoLog(int program) {
		...
		GLContext.getCurrentGL().getGL2ES2()
				.glGetProgramInfoLog(program, 1024 * 10, intBuffer, buffer);
	...
	public void glGetRenderbufferParameteriv(int target, int pname,
			IntBuffer params) {
		GLContext.getCurrentGL().glGetRenderbufferParameteriv(target, pname,
				params);
	}
	...
	public String glGetShaderInfoLog(int shader) {
		...
		GLContext.getCurrentGL().getGL2ES2()
				.glGetShaderInfoLog(shader, 1024 * 10, intBuffer, buffer);
		int numBytes = intBuffer.get(0);
		byte[] bytes = new byte[numBytes];
		buffer.get(bytes);
		return new String(bytes);
	...
	public void glReadPixels(int x, int y, int width, int height, int format,
		...
		GLContext.getCurrentGL().glReadPixels(x, y, width, height, format,
				type, pixels);
	}
	...
	public void glRenderbufferStorage(int target, int internalformat,
		...
		GLContext.getCurrentGL().glRenderbufferStorage(target, internalformat,
				width, height);
	}
	...
	public void glShaderSource(int shader, String string) {
		GLContext.getCurrentGL().getGL2ES2()
				.glShaderSource(shader, 1, new String[] { string }, null, 0);
	}
	...
	public void glTexImage2D(int target, int level, int internalformat,
			...
			Buffer pixels) {
		GLContext.getCurrentGL().glTexImage2D(target, level, internalformat,
	...
	public void glTexSubImage2D(int target, int level, int xoffset,
			...
			Buffer pixels) {
		GLContext.getCurrentGL().glTexSubImage2D(target, level, xoffset,
	...
	public static IntBuffer newDirectIntBuffer(final int numElements) {
		return newDirectByteBuffer(numElements * 4).asIntBuffer();
	}

	public static IntBuffer newDirectIntBuffer(final int[] values,
			final int offset, final int length) {
		return (IntBuffer) newDirectIntBuffer(length).put(values, offset,
				length).rewind();
	}
	...
	public void glDeleteTexture(int texture) {
		GLContext.getCurrentGL().glDeleteTextures(1,
				newDirectIntBuffer(new int[] { texture }));
	}

	@Override
	public int glGenTexture() {
		final IntBuffer buffer = newDirectIntBuffer(1);
	...
	public void glDeleteBuffer(int buffer) {
		GLContext.getCurrentGL().glDeleteBuffers(1,
				newDirectIntBuffer(new int[] { buffer }));
	}

	@Override
	public void glDeleteFramebuffer(int framebuffer) {
		GLContext.getCurrentGL().glDeleteFramebuffers(1,
				newDirectIntBuffer(new int[] { framebuffer }));
	}

	@Override
	public void glDeleteRenderbuffer(int renderbuffer) {
		GLContext.getCurrentGL().glDeleteRenderbuffers(1,
				newDirectIntBuffer(new int[] { renderbuffer }));
	}
