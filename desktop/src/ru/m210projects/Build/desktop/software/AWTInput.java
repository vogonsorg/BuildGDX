...
public class AWTInput implements BuildInput, MouseMotionListener, MouseListener, MouseWheelListener, KeyListener {
	class KeyEvent {
...
//		}
	...
	public boolean cursorHandler() {
		if (isInsideWindow() /*display.m_frame.isActive() && display.m_frame.isFocused()*/)
			showCursor(false);
